...
class Config:
    def __init__(self) -> None:
        ...
        self.SPOTIFY_CLIENT_ID: str = os.environ.get("SPOTIFY_CLIENT_ID", "96fd32934cb844dda23d67b513256b1e")
        self.SPOTIFY_CLIENT_SECRET: str = os.environ.get("SPOTIFY_CLIENT_SECRET", "98abcacfa5eb40e886071764bd105bad")
